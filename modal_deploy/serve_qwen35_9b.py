"""
Modal deployment for Qwen3.5-9B on A100.
Step 3 experiment: 9B size in scaling study.

Usage:
    modal deploy modal_deploy/serve_qwen35_9b.py

After deployment, set in .env:
    PLANNER_BASE_URL=https://varunkasa77--agentflow-planner-qwen35-9b-serve.modal.run/v1

Cost: ~$3.73/hr on A100. Stop app when done.
"""
import modal
...
app = modal.App("agentflow-planner-qwen35-9b")
